...
class IconsDripicons extends Component{
                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><Link to="/">Veltrix</Link></li>
                                <li class="breadcrumb-item"><Link to="#">Components</Link></li>
                                <li class="breadcrumb-item"><Link to="#">Icons</Link></li>
